...
use self::blocking_check::BlockingCheck;
use self::condition::{insufficient_battery::InsufficientBattery, Condition};
use self::node::NodeError;
use crate::c2::blackboard::Blackboard;
use crate::c2::planners::PlannerInterface;
use crate::comms::platform::mavlink_vehicle::MavlinkVehicle;
use condition::goal_height::GoalHeight;
use fallback::Fallback;
use loop_dec::LoopDecorator;
...
pub struct BehaviorTree {
    ...
    pub bt_type: Option<BTs>,
}

impl BehaviorTree {
    fn new(root_node: NodeHandle) -> Self {
        Self {
            root_node,
            handles: None,
            bt_type: None,
    ...
    fn new_complete(root_node: NodeHandle, handles: Vec<NodeHandle>, bt_type: BTs) -> Self {
...
mod tests {
    ...
    use super::*;
    use crate::action::{MockAction, MockBlockingAction};
    use crate::comms::actors::Handle;
    use crate::condition::MockAsyncCondition;
    use crate::core::models::detection::Detection;
    use crate::setup::logging::load_logger;
    ...
    async fn test_if_vec_not_empty() {
        // Setup
        let handle: Handle<Vec<Detection>> = Handle::new_from(vec![]);
